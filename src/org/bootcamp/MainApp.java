...
public class MainApp {
    ...
    private static final String OUTPUT_FORMAT = "Vehicle with id %s and type %s has total cost %d";
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            for (InsuranceCalculationResult result : resultList) {
                final String output = String.format(OUTPUT_FORMAT, result.getId(), result.getVehicleType(), result.getCost());
